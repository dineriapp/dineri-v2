...
export const Comparison = () => {
  const c = {
    ...
    generic: {
      title: "The old way",
      items: [
        "Slow mobile website. Guests leave before they even look",
        "Reservation system that charges per booking",
        "Delivery platforms taking 25-30% commission",
        "No-shows with no protection",
        "Website you can't update yourself",
      ],
    },
    dineri: {
      title: "Dineri",
      items: [
        "Beautiful mobile page. Live in 10 minutes",
        "Commission-free reservations",
        "Food ordering. Zero commission",
