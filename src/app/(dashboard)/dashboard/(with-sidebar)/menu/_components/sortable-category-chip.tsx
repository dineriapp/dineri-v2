...
import { Eye, EyeOff, GripVertical, LayoutGrid, Pencil, Trash2 } from "lucide-react";
...
export const SortableCategoryChip = ({
  category,
  selectedCategoryId,
  isDragOverlay = false,
  onSelect,
  ...
  const show = category.show_on_public_page;
